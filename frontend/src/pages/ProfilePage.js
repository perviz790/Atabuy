              ...
              <div>
                ...
                {profileData.saved_cards && profileData.saved_cards.length > 0 && (
                  <div className="mb-8 space-y-3">
                    ...
                    {profileData.saved_cards.map((card) => (
                      <div key={card.id} className="border rounded-lg p-4 flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          <CreditCard className="w-8 h-8 text-gray-400" />
                          <div>
                            <div className="font-semibold">{card.card_holder}</div>
                            <div className="text-sm text-gray-600">•••• {card.last4}</div>
                            <div className="text-xs text-gray-500">{card.brand} • {card.exp_month}/{card.exp_year}</div>
                          </div>
                        </div>
                        <button
